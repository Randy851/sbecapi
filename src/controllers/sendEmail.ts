...
class correoController{
    ...
    public enviarInfoDeposito (req: Request, res: Response){
        let datosCorreo =  req.body;       
    ...
    public enviarCorreoTransferencia(_datos:any, res:any){
    ...
    public enviarCorreoError(_datos:any, res:any){
        var mailOptions = {
            from: `"SBEC" <${correoEnvio}>`,
...
function construirTabla(_datos: any){
...
function correoTransferencia(_datos: any){
    return ` <table style="border: black 1px solid;border-collapse: collapse;">
                <thead>
                    <tr>
...
function correoError(_datos: any){
    // let referenciaHTML = (_datos.referencia) ? `<tr>
    //                         <td>REFERENCIA</td>
    //                         <td colspan="2">${_datos.referencia}</td>
    //                     </tr>` : '';
...
export default correoControllers;